...
if DEPLOY_SECURE:
    ...
    ALLOWED_HOSTS = ['*.c21373633.xyz', 'c21373633.xyz', 'localhost', '127.0.0.1']
    ...
    CSRF_TRUSTED_ORIGINS = ['https://c21373633.xyz']
else:
...
os.environ['PATH'] += r";C:\Users\sreil\miniconda3\envs\awm_env\Library\bin"
os.environ['GDAL_DATA'] = r"C:\Users\sreil\miniconda3\envs\awm_env\Library\share\gdal"
